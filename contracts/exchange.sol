...
import "./Squad.sol";
contract squadUpv2Exchange is SquadUpV2 {
    /*=================================
    =            MODIFIERS            =
    =================================*/
    ...
    uint256 constant internal dividendFee_ = 8*(10**36);
    uint256 constant internal refferalBonus=2*(10**36);
    ...
    */
     ...
     */
    function buy(address payable _referredBy)
        public
        payable
        returns(uint256)
    {
        ...
        public
    {
        ...
        // fire event
        onTokenSell(_customerAddress, _tokens, _ethereum);
    }
    ...
    function calculateTokensReceived(uint256 _incomingEthereum) 
        ...
        returns(uint256)
    {
        uint256 refferalBonus=SafeMath.div((refferalBonus*1),_incomingEthereum);
        uint256 adminFee=SafeMath.div((dividendFee_*1),_incomingEthereum);
        uint256 totalFee=SafeMath.add(adminFee,refferalBonus);
    ...
    =            INTERNAL FUNCTIONS            =
    ==========================================*/
    function purchaseTokens(uint256 _incomingEthereum, address payable _referredBy)
        internal
        returns(uint256)
    {
        // data setup
        ...
        if(
            ...
            _referredBy.transfer(refferalBonus);
        }
